 ...
 */
final class Version20220425115650 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE massage CHANGE description description VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE massage CHANGE description description VARCHAR(500) NOT NULL');
    }
}
