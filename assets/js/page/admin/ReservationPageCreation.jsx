...
const ReservationPageCreation = (props) => {
    ...
    return (
        ...
        <div className="py-3 mx-1">
            <h1 className="font-link text-center mt-1">Créer une réservation</h1>
            <form onSubmit={handleSubmit} className="row">
                ...
                <div className="form-group">
                    <button type="submit" className="btn btn-primaire fs-3 mt-3 col-12">Créer une réservation</button>
                </div>
            </form>
        </div>
    );
