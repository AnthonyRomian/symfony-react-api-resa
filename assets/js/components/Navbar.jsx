        ...
        <>
            <nav className="navbar navbar-expand-lg" id="navbar">
                <div className="container container-fluid ">
                    <a className="navbar-brand col col-sm-8 col-lg-4 " to="#"><img
                    ...
                    <button onClick={handleNavCollapse} className="navbar-toggler" type="button"
                            data-bs-toggle="collapse" data-bs-target="#navbarColor03" aria-controls="navbarColor03" aria-expanded="false" aria-label="Toggle navigation">
                    ...
                    <div className={`col ${isNavCollapsed ? 'collapse' : ''} navbar-collapse `} id="navbarColor03">
                        <ul className="navbar-nav me-auto mb-2  mb-lg-0">
                            ...
                            <li className="nav-item text-center mx-2">
                                <NavLink className="nav-link py-1 color-secondaire font-link-2  fs-3 " to="/massages">Les
                                    Massages</NavLink>
                            </li>
                            <li className="nav-item text-center mx-2">
                                <NavLink className="nav-link py-1 color-secondaire font-link-2  fs-3 " to="/livre">Livre
                                    d'or</NavLink>
                            </li>
                            <li className="nav-item text-center mx-2">
                                <NavLink className="nav-link py-1 color-secondaire font-link-2  fs-3 "
